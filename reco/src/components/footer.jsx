                ...
                <div className="flex flex-col md:flex-row justify-between gap-0 ">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2 mb-3">
                            <Image src="/footer/phonecall.svg" width={20} height={20} alt="Phone Icon" />
                            <p className="text-lg">+1012 3456 789</p>
                        </div>

                        <div className="flex items-center gap-2 mb-3">
                            <Image src="/footer/email.svg" width={20} height={20} alt="Email Icon" />
                            <p className="text-lg">revive@gmail.com</p>
                        </div>

                        <div className="flex items-center gap-2">
                            <Image src="/footer/location.svg" width={20} height={20} alt="Location Icon" />
